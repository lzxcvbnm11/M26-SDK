...
typedef struct CAN_MESSAGE_INFO_Tag
{
	u32 id;
	u8 data[8];
}CAN_MESSAGE_INFO_ST;

#define CYCLE_CAN_MESSAGE_CNT 11

typedef struct  CYCLE_CAN_MESSAGE_Tag
{
	CAN_MESSAGE_INFO_ST can_message[CYCLE_CAN_MESSAGE_CNT];
}CYCLE_CAN_MESSAGE_ST;

#define ALL_CAN_MESSAGE_CNT 198
#define CAN_ID_MASK 0x00ffffff
#define get_u16_h(u16) ((u16>>8)&0xff)
#define get_u16_l(u16) ((u16)&0xff)
